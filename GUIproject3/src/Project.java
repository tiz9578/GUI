...
public class Project {
	...
	private ImageIcon pink;
	private ImageIcon blue;

	public void createAndShowGui() {

		this.frame = new JFrame("Metronome");
		...
		// Load the images for vol:

		this.mute = new ImageIcon(this.getClass().getResource("images/mute.png"));
		this.min = new ImageIcon(this.getClass().getResource("images/low.png"));
		this.med = new ImageIcon(this.getClass().getResource("images/med.png"));
		this.max = new ImageIcon(this.getClass().getResource("images/high.png"));

		// Load the images for metronome:

		this.black = new ImageIcon(this.getClass().getResource("images/black.png"));
		this.pink = new ImageIcon(this.getClass().getResource("images/pink.png"));
		this.blue = new ImageIcon(this.getClass().getResource("images/blue.png"));

		JLabel labelSlider = new JLabel("Volume Control:");
		this.bottomPane.setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));
		...
		this.topPane.setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));
		...
		JTextField volumeField = new JTextField(2);
		...
		JToggleButton blackBtn = new JToggleButton("black");
		JToggleButton pinkBtn = new JToggleButton("pink");
		JToggleButton blueBtn = new JToggleButton("blue");
		JPanel ToglePanel = new JPanel();
		JLabel metroImg = new JLabel(this.black);
		buttonGroup.add(blackBtn);
		buttonGroup.add(pinkBtn);
		buttonGroup.add(blueBtn);
		ToglePanel.add(blackBtn);
		ToglePanel.add(blueBtn);
		ToglePanel.add(pinkBtn);
		ToglePanel.setBorder(BorderFactory.createTitledBorder("Change Color"));

		this.bottomPane.add(ToglePanel);
		this.topPane.add(metroImg);
		...
		blackBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (e.getActionCommand().equals("black")) {
					metroImg.setIcon(Project.this.black);
				}
			}
		});
		...
		pinkBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (e.getActionCommand().equals("pink")) {
					metroImg.setIcon(Project.this.pink);
				}
			}
		});
		...
		blueBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (e.getActionCommand().equals("blue")) {
					metroImg.setIcon(Project.this.blue);
				}
			}
		});
		...
		visualMetro.setBorder(BorderFactory.createTitledBorder("Mute Sound"));
		...
		this.frame.getContentPane().add(this.containerPane);
